#
# Module manifest for module 'FineFormat'
#
# Generated by: SergeyVasin
#
...
NestedModules = @('FineFormat.completers.ps1', 'FineFormat.functions.ps1')
...
FileList = @('FineFormat.psd1', 'FineFormat.psm1', 'FineFormat.functions.ps1')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ProjectUri = 'https://github.com/sethworks/FineFormat'
